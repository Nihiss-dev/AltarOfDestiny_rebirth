...
void AS_PlayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AS_PlayerCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AS_PlayerCharacter::TouchStopped);
}

void AS_PlayerCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AS_PlayerCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
